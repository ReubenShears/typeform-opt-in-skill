...
- disqualification routing → **Qualified Calendar** vs **Unqualified Calendar** (Calendly); Calendly then redirects bookers to the confirmation pages
...
and reads everything else (company, ICP signals, calendar links) from that row, then writes the new form URL
